...
La herramienta de software \textsc{CMake} fue la utilizada para preparar la compilación del código desarrollado, en donde los compiladores utilizados son \textit{gcc} y \textit{nvcc}.  El archivo CMakeLists.txt principal tiene que encontrarse en la carpeta principal del proyecto \cite{cmake:2020:kitware}, y contiene todas las instrucciones de compilación que debe/puede tener un proyecto a trabajar. A continuación se detallan las instrucciones más relevantes.
