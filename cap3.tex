...
Una computadora (\textit{Personal Computer} o PC) posee como procesador principal la CPU. Éste procesador principal se encuentra diseñado principalmente para realizar tareas secuenciales, comercialmente vienen de una amplia variedad de núcleos, llendo de 8 a 64 núcleos en el caso de los Procesadores AMD Ryzen™ Threadripper, 4 a 8 núcleos en los Procesador AMD FX™, en el caso de Intel se encuentra el Procesador Intel® Core™ serie X con 18 núcleos y  Intel® Core™ i3-9100T de 4 núcleos entre otros.

Es posible realizar tareas y procesos en paralelo dando instrucciones a cada uno de los núcleos del procesador, siendo más efectivo en el desarrollo de las ejecuciones a realizar.
