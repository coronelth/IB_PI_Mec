...
\begin{table}[h!]
	...
	\begin{tabular}{|c|c|c|cccc}
		...
		Threads                                                                        & 8              & 8              & \multicoludesarrolladoresmn{1}{c|}{} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Frecuencia de \\ reloj normal {[}MHz{]}\end{tabular}}       & \multicolumn{1}{c|}{980}           & \multicolumn{1}{c|}{1050}          \\ \cline{1-3} \cline{5-7} 
