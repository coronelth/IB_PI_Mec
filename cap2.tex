...
Por medio de la resolución de una LBE para la función de distribución \textit{f} (Ec.(\ref{eq:fieldmom})), se puede obtener la solución de las ecuaciones hidrodinámicas \cite{li2013lattice}:
