...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|c|c|c|}
		\hline
		\begin{tabular}[c]{@{}c@{}}Número de \\ elementos de malla\end{tabular} & \begin{tabular}[c]{@{}c@{}}CPU Intel\\ Core i7-3770\end{tabular} & \begin{tabular}[c]{@{}c@{}}GPU NVIDIA\\ GeForce GTX 760\end{tabular} & \begin{tabular}[c]{@{}c@{}}CPU Intel\\ Core i7-4770\end{tabular} & \begin{tabular}[c]{@{}c@{}}GPU NVIDIA\\ GeForce GTX 970\end{tabular} \\ \hline
$2^{8}$	&$2.04\cdot10^{-4}$                                                                  &$1.74\cdot10^{-4}$                                                                      &$1.86\cdot10^{-4}$                                                                  &$7.14\cdot10^{-5}$                                                                      \\ \hline
$2^{10}$&  $8.12\cdot10^{-4}$                                                                & $1.87\cdot10^{-4}$                                                                     &    $7.47\cdot10^{-4}$                                                              &    $8.04\cdot10^{-5}$                                                                  \\ \hline
$2^{12}$		&  $3.25\cdot10^{-3}$                                                                &$3.13\cdot10^{-4}$           &$3.02\cdot10^{-3}$                                                                  &$1.34\cdot10^{-4}$                                         \\ \hline
...
%$2^{8}$ & $2^{10}$& $2^{12}$& $2^{14}$& $2^{16}$& $2^{18}$& $2^{20}$& $2^{22}$& $2^{24}$\\ \hline
...
\begin{table}[H]
	...
	\resizebox{15cm}{!}{
		\begin{tabular}{|c|c|c|c|c|}
			\hline
			\begin{tabular}[c]{@{}c@{}}Número de \\ elementos de malla\end{tabular} & \begin{tabular}[c]{@{}c@{}}CPU Intel\\ Core i7-3770\end{tabular} & \begin{tabular}[c]{@{}c@{}}GPU NVIDIA\\ GeForce GTX 760\end{tabular} & \begin{tabular}[c]{@{}c@{}}CPU Intel\\ Core i7-4770\end{tabular} & \begin{tabular}[c]{@{}c@{}}GPU NVIDIA\\ GeForce GTX 970\end{tabular} \\ \hline
			$9\cdot10^{2}$	&$8.39\cdot10^{-4}$&$3.85\cdot10^{-4}$ &$7.29\cdot10^{-4}$ &$1.59\cdot10^{-4}$ \\ \hline
			$1.2\cdot10^{3}$&$1.12\cdot10^{-3}$ &$3.92\cdot10^{-4}$ &$9.71\cdot10^{-4}$ &$1.62\cdot10^{-4}$ \\ \hline
			$2.4\cdot10^{3}$&$2.24\cdot10^{-3}$ &$4.70\cdot10^{-4}$ &$1.94\cdot10^{-3}$ &$1.94\cdot10^{-4}$ \\ \hline
			$4.8\cdot10^{3}$&$4.48\cdot10^{-3}$ &$6.60\cdot10^{-3}$ &$4.05\cdot10^{-3}$ &$1.83\cdot10^{-3}$ \\ \hline
			$9.6\cdot10^{3}$&$8.96\cdot10^{-3}$ &$1.83\cdot10^{-3}$ &$7.78\cdot10^{-3}$ &$4.85\cdot10^{-3}$ \\ \hline
			$1.9\cdot10^{4}$&$1.81\cdot10^{-2}$ &$2.02\cdot10^{-3}$ &$1.58\cdot10^{-2}$ &$3.11\cdot10^{-3}$ \\ \hline
			$3.8\cdot10^{4}$&$3.61\cdot10^{-2}$ &$3.45\cdot10^{-3}$ &$3.12\cdot10^{-2}$ &$4.61\cdot10^{-3}$ \\ \hline
			$7.6\cdot10^{4}$&$7.30\cdot10^{-2}$ &$6.22\cdot10^{-3}$ &$6.49\cdot10^{-2}$ &$2.48\cdot10^{-2}$ \\ \hline
			$1.5\cdot10^{5}$&$2.93\cdot10^{-2}$ &$2.33\cdot10^{-3}$ &$2.52\cdot10^{-2}$ &$4.05\cdot10^{-2}$ \\ \hline
			$3.0\cdot10^{5}$&$2.94\cdot10^{-1}$ &$2.24\cdot10^{-2}$ &$2.55\cdot10^{-1}$ &$5.39\cdot10^{-2}$ \\ \hline
			$6.1\cdot10^{5}$&$1.17\cdot10^{-1}$ &$8.82\cdot10^{-2}$ &$1.01\cdot10^{-1}$ &$1.85\cdot10^{-1}$ \\ \hline
			$1.2\cdot10^{6}$&$1.17$ &$8.82\cdot10^{-2}$ &$1.02$ &$1.41\cdot10^{-1}$ \\ \hline
			$2.4\cdot10^{6}$&$1.17$ &$8.90\cdot10^{-2}$ &$1.03$ &$1.64\cdot10^{-1}$ \\ \hline
			$4.9\cdot10^{6}$&$4.92$ &$3.54\cdot10^{-1}$ &$4.09$ &$2.69\cdot10^{-1}$ \\ \hline
