...
Debido a que en la cersión 1.0 del código se lograron mejoras significativas en los tiempos de cálculos con implementaciones poco sofisticadas, es que se propuso mejorar la efiiciencia del código.

Una de las ramas posibles es mediante cambios de instrucciones del optimizador, mientras que por otro lado se encuentran las realizadas en el código. Las optimizaciones realizadas son de este último tipo, y se propone la investigación del primer tipo como una futura mejora.

 implementación y validación del código 

En la presente sección se muestran los resultados luego de haber realizado un optimización simple al código. 
