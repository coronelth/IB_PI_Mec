...
\end{align*}
El tamaño de grilla utilizado fue de L = 300 y H = 500 basándose en el esquema de la Figura(\ref{fig:esquema_VdW}), donde la superficie calefaccionada se encuentra en el centro del lado L y posee un tamaño de 24 elementos de malla. La temperatura de calefacción $T_{heat} = T_c$  y el resto de la superficie se encuentra a $T = 0.8 T_c$ con la parte superior de la cavidad está a $T = 0.99 T_c$. La separación inicial de las dos fases se encuentra en $y = 350$, donde $\rho = 0.1610588 \> si \> y \in [0,350]$ y $\rho = 0.0199722$ $y$ para $(350,500]$.

El resultado que se obtuvo para 5000, 10000, 20000, 25000, 30000, 35000, 40000, 45000 y 50000 pasos de tiempo se encuentran en las Figuras (\ref{fig:secuencia_burbujas}) y (\ref{fig:secuencia_burbujas}), realizas en la GPU NVIDIA GeForce GTX 970 en doble precisióny CPU Intel Core i7-4770 en simple precisión respectivamente, en donde se aprecia la formación, creación y desprendimiento mencionado anteriormente.  

Si se observan las Figuras Figuras (\ref{fig:secuencia_burbujas}) y (\ref{fig:secuencia_burbujas}), a simple vista no se halla ninguna diferencia entre los resultados que fueron en precisiones y lenguajes distintos.
